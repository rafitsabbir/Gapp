...
import com.sharestream.api_demo.utils.NetworkConnectivityReceiver;
import com.sharestream.api_demo.AnimationView;
...
public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.room1:
			...
			bistriConfig.StartCall("room1");
			animationView.setRoomName("room1");
			animationView.EnableDraw();
			return true;
		...
		case R.id.room2:
			...
			/*
			 * case R.id.room3: // send
			 * bistriConfig.StartCall(getString(R.string.room3));
			 * animationView.setRoomName(getString(R.string.room3)); return
			 * true;
			 * 
			 * case R.id.room4: // send
			 * bistriConfig.StartCall(getString(R.string.room4));
			 * animationView.setRoomName(getString(R.string.room4)); return
			 * true;
			 */
